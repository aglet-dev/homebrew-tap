...
class Aglet < Formula
  ...
  url "https://github.com/aglet-dev/homebrew-tap/releases/download/aglet-v0.3.0/aglet-cli-0.3.0-universal-apple-darwin.tar.gz"
  version "0.3.0"
  sha256 "865d5acb812d1b7c02d660c6e2cbceaf168051bd5f9ebe5f5defa9d44308c731"
  license "MIT"
