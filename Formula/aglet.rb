...
class Aglet < Formula
  ...
  url "https://github.com/aglet-dev/homebrew-tap/releases/download/aglet-v0.1.7/aglet-cli-0.1.7-universal-apple-darwin.tar.gz"
  version "0.1.7"
  sha256 "e3a4e4f812dd79422ff55ede35498c8a0764d2eca1fd4e5cfe711b894673d2b6"
  license "MIT"
